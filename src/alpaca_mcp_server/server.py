...
from .toolsets import OVERRIDE_OPERATION_IDS, get_active_operations
...
def build_server() -> FastMCP:
    ...
    if trading_client is not None:
        _register_overrides(main, trading_client)

    return main


def _register_overrides(server: FastMCP, trading_client: httpx.AsyncClient) -> None:
    """Register hand-crafted override tools that replace auto-generated ones."""
