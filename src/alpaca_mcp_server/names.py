...
TOOLS: dict[str, ToolOverride] = {
    ...
    "deleteOpenPosition": ToolOverride(
        name="close_position",
        description="Closes a specific position for a single symbol.",
    ),
    ...
    "get-v2-assets": ToolOverride(
        name="get_all_assets",
        description="Get all available assets with optional filtering.",
    ),
    ...
    "LegacyCalendar": ToolOverride(
        name="get_calendar",
        description="Retrieves and formats market calendar for specified date range.",
    ),
    ...
    "CryptoLatestBars": ToolOverride(
        ...
        description="Returns the latest minute bar for one or more crypto symbols.",
    ),
    "CryptoLatestQuotes": ToolOverride(
        name="get_crypto_latest_quote",
        description="Returns the latest quote for one or more crypto symbols.",
    ),
    "CryptoLatestTrades": ToolOverride(
        name="get_crypto_latest_trade",
        description="Returns the latest trade for one or more crypto symbols.",
    ),
    ...
    "CryptoLatestOrderbooks": ToolOverride(
        ...
        description="Returns the latest orderbook for one or more crypto symbols.",
    ),
